            ...
            <x-table-component :headers="['#', 'Name', 'Icon', 'Description', 'Status', 'Action']">
                ...
                @foreach ($brandServices as $item)
                    <tr style="padding: 0" data-id="{{ $item->id }}">
                        ...
                        <td style="padding: 0">
                            <div class="d-flex">
                                <a href="{{ route('branding-services.edit', $item) }}" style="margin-top: 10px"
                                    class="btn text-warning shadow-none">Edit</a>

                                <form action="{{ route('branding-services.destroy', $item) }}" method="POST"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form
                    action="{{ $brandService?->id ? route('branding-services.update', $brandService) : route('branding-services.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label for="">Service Category <span class="text-danger">*</span></label>
...
@push('script')
    <script>
        $(document).on('change', '.status-toggle', function() {
            ...
            $.ajax({
                url: `/admin/brands/leading-brands/${id}/toggle-status`,
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    status: status
