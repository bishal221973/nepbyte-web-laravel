...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Marketting Category</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Marketting</li>
    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            <x-table-component :headers="['#', 'Name', 'Description', 'Action']">
                <x-slot name="actions">
                ...
                @foreach ($brandServices as $item)
                    <tr style="padding: 0" data-id="{{ $item->id }}">
                        ...
                        <td style="padding: 0">
                            <div class="d-flex">
                                <a href="{{ route('marketting-category.edit', $item) }}" style="margin-top: 10px"
                                    class="btn text-warning shadow-none">Edit</a>

                                <form action="{{ route('marketting-category.destroy', $item) }}" method="POST"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form
                    action="{{ $brandService?->id ? route('marketting-category.update', $brandService) : route('marketting-category.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Marketing category" name="name"
                         ...
                         <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="category icon" name="icon"
                                value="{{ old('icon', $brandService?->icon) }}">
                            @error('icon')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
