            ...
            <x-table-component :headers="['#', 'Name', 'Description', 'Action']">
                ...
                @foreach ($developmentCategories as $item)
                    <tr style="padding: 0" data-id="{{ $item->id }}">
                        ...
                        <td style="padding: 0">
                            <div class="d-flex">
                                <a href="{{ route('development-category.edit', $item) }}" style="margin-top: 10px"
                                    class="btn text-warning shadow-none">Edit</a>

                                <form action="{{ route('development-category.destroy', $item) }}" method="POST"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form
                    action="{{ $developmentCategory?->id ? route('development-category.update', $developmentCategory) : route('development-category.store') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Development category" name="name"
                                value="{{ old('name', $developmentCategory?->name) }}">
                            @error('name')
