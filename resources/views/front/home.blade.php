...
@section('content')
    ...
    <div class="fab-options">
        ...
        <a href="https://www.facebook.com/surkhetsoft" class="text-decoration-none fab-item facebook" target="_blank">
            <i class="fab fa-facebook-f"></i>
        </a>

        <a href="https://www.facebook.com/surkhetsoft" class="text-decoration-none fab-item instagram" target="_blank">
